        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              {({ isActive }) => (
                <>
                  <span className={cn('flex size-6 items-center justify-center rounded-full', isActive && 'bg-gradient-to-br from-theme-yellow/80 via-theme-cyan/25 to-theme-sky/20 text-theme-main-dark')}>
                    <Icon size={16} />
                  </span>
                  {item.label}
                </>
