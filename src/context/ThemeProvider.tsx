...
export const themes: ThemeDefinition[] = [
  {
    id: 'natural',
    name: 'Blue Bloom',
    description: 'Blue Bloomを軸に、黄色とAquaが軽くひらく標準テーマ',
    colors: {
      main: brandPalette.blueBloom,
      mainDark: brandPalette.softNavyText,
      accent: brandPalette.aquaBloom,
      accentSoft: brandPalette.mistBloom,
      background: brandPalette.background,
      card: brandPalette.surface,
      text: brandPalette.softNavyText,
  ...
  },
  {
    id: 'sakura',
    name: 'Yellow Bloom',
    description: 'Yellow Bloomをポイントに使う、明るく親しみやすいテーマ',
    colors: {
      main: brandPalette.blueBloom,
      mainDark: brandPalette.softNavyText,
      accent: brandPalette.yellowBloom,
      accentSoft: '#FFF7C2',
      background: '#F8FBFF',
      card: brandPalette.surface,
      text: brandPalette.softNavyText,
  ...
  },
  {
    ...
    colors: {
      main: brandPalette.aquaBloom,
      mainDark: brandPalette.softNavyText,
      accent: brandPalette.skyBloom,
      accentSoft: '#DDFBFA',
      background: '#F4FEFF',
      card: brandPalette.surface,
      text: brandPalette.softNavyText,
  ...
  },
  {
    ...
    colors: {
      main: brandPalette.skyBloom,
      mainDark: brandPalette.softNavyText,
      accent: brandPalette.blueBloom,
      accentSoft: '#EAF7FF',
      background: '#F5FBFF',
      card: brandPalette.surface,
      text: brandPalette.softNavyText,
