    ...
    <section className="relative min-h-screen overflow-hidden px-4 py-6">
      ...
      <div className="relative mx-auto flex max-w-md flex-col gap-6">
        ...
        <div className="flower-gradient soft-shadow relative overflow-hidden rounded-[2.25rem] p-1">
          ...
          <div className="space-y-6 rounded-[2rem] bg-theme-card/78 p-6 pt-8 backdrop-blur-md">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl font-black leading-[1.05] tracking-[-0.06em] text-theme-text">縁が、<br />恋に咲く。</h1>
