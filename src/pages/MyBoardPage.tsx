...
import { Archive, CalendarDays, Eye, MapPin, RotateCcw, Trash2, UsersRound, XCircle } from 'lucide-react';
      ...
      <div className="space-y-4">
        {posts.map((post) => (
          <Card className="space-y-3" key={post.id}>
            ...
            <div className="grid gap-2 border-t border-white/60 pt-3 sm:grid-cols-2 lg:grid-cols-5">
              ...
              <Link className="inline-flex min-h-11 items-center justify-center gap-1.5 rounded-xl bg-theme-main px-4 py-2 text-[13px] font-bold text-white" to={`/board/${post.id}`}><UsersRound size={16} />管理する</Link>
