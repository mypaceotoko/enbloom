-- Admin-only report review RPC.
-- Keeps moderation updates focused on status / admin_note / reviewed_at, while RLS
-- and public.is_admin() continue to protect access to report review operations.
